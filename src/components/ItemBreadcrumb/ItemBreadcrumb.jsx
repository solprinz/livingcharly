...
const ItemBreadcrumb = ({nombre_producto, categoria}) => {
    ...
    let category =   categoria.toLowerCase(); //To convert Lower Case
    let catlink = category.replace(" ", "-")
    ...
    return (
        <div>
            ...
            </svg> <Link to={`/catalogo#${catlink}`}>{categoria} </Link> <svg xmlns="http://www.w3.org/2000/svg" width="8" height="14" viewBox="0 0 8 14" fill="none">
